...
* Информация загружается с сервера
* Возможность изменить аватар пользователя
* ~~Добавлена валидация введенных данных~~
* Реализована нативная валидация введенных данных
* Редактирование профиля пользователя
* Добавлена кнопка удаления карточки
* Перед удалением карточки - всплывающее окно подтверждения
...
* Реализованы регистрация, авторизация и аутентификация
